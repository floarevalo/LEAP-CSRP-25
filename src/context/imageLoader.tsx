...
// --- Force Webpack to keep all images ---
const _preloadAllImages = [
  airAssaultBLUE, airAssaultRED,
  airDefenseBLUE, airDefenseRED,
  ammunitionBLUE, ammunitionRED,
  armoredBLUE, armoredRED,
  armoredTrackedBLUE, armoredTrackedRED,
  combatServiceBLUE, combatServiceRED,
  combatSupportBLUE, combatSupportRED,
  combinedArmsBLUE, combinedArmsRED,
  commandControlBLUE, commandControlRED,
  electronicWarfareBLUE, electronicWarfareRED,
  engineerBLUE, engineerRED,
  fieldArtilleryBLUE, fieldArtilleryRED,
  infantryBLUE, infantryRED,
  medicalBLUE, medicalRED,
  petroleumBLUE, petroleumRED,
  railheadBLUE, railheadRED,
  reconBLUE, reconRED,
  rotaryBLUE, rotaryRED,
  seaPortBLUE, seaPortRED,
  selfPropelledBLUE, selfPropelledRED,
  signalBLUE, signalRED,
  specialOperationsBLUE, specialOperationsRED,
  sustainmentBLUE, sustainmentRED,
  unmannedBLUE, unmannedRED,
];

console.log('Preloaded images to prevent tree-shaking:', _preloadAllImages);
